...
def search_venues():
  ...
  data = Venue.query.filter(Venue.name.like('%' + searchTerm + '%')).all()
  print(data)
  count = len(data)
  response = {
    "count" : count,
...
def show_venue(venue_id):
  ...
  data = {
    ...
    "past_shows_count": len([show for show in venue.shows if datetime(show.start_time.year, show.start_time.month, show.start_time.day )< datetime.now()]),
    "past_shows": [show for show in venue.shows if datetime(show.start_time.year, show.start_time.month, show.start_time.day )< datetime.now()],
    "upcoming_shows_count": len([show for show in venue.shows if datetime(show.start_time.year, show.start_time.month, show.start_time.day )> datetime.now()]),
    "upcoming_shows":[show for show in venue.shows if datetime(show.start_time.year, show.start_time.month, show.start_time.day )> datetime.now()],
...
def create_show_submission():
  ...
  try:
     print(request.form)
     newshow = Shows(start_time=request.form["start_time"], venue_id=request.form["venue_id"], artist_id=request.form["artist_id"])
